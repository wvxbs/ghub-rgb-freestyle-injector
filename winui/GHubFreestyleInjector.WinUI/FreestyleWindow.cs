...
internal sealed class FreestyleWindow : Window
{
    ...
    public FreestyleWindow()
    {
        App.LogInfo("FreestyleWindow manual content start");
        RootGrid = new Grid();
        Content = RootGrid;
        App.LogInfo("FreestyleWindow manual content done");
        BuildUi();
        App.LogInfo("FreestyleWindow BuildUi done");

        _hwnd = WindowNative.GetWindowHandle(this);
        App.LogInfo($"FreestyleWindow HWND acquired: {_hwnd}");
